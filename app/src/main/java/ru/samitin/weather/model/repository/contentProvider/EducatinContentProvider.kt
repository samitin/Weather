package ru.samitin.weather.model.repository.contentProvider
...
import ru.samitin.weather.model.room.*
...
// Прочитаем часть пути из ресурсов
        authorities = context?.resources?.getString(R.string.autorities)
...
// Устанавливаем нотификацию при изменении данных в content_uri
    ...
    // Удаляем запись
    override fun delete(
        uri: Uri, selection: String?, selectionArgs:
        Array<String>?
    ): Int {
